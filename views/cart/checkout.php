        ...
        <div class="row">
            ...
            <div class="col-sm-9 padding-right">
                <div class="features_items">
                    ...
                    <?php if ($result): ?>
                        <p>El pedido está realizado. Le responderemos lo antes posible.</p>
                    <?php else: ?>

                        <p class="admin-text-color">Productos seleccionados: <?php echo $totalQuantity; ?>, por cantidad: <?php echo $totalPrice; ?>, $</p><br/>

                        <?php if (!$result): ?>                        

                            <div class="col-sm-4 admin-text-color">
